...
# Google Gemini LLM and Embedding Model Choices
# **IMPORTANT CHANGE HERE:** Use the updated model names
GEMINI_LLM_MODEL = "gemini-1.5-flash" # Or "gemini-1.5-pro" for higher capability
GEMINI_EMBEDDING_MODEL = "models/embedding-001"

# --- The rest of your code remains exactly the same ---
# ... (get_llm, get_embeddings, load_documents_from_dir, get_vector_store, get_rag_chain,
#           and the Streamlit UI parts from the previous answer) ...
...
st.title("👨‍💻 Streamlit Copilot Assistant (Powered by Google Gemini)")
...
# --- 4. Session State Management for Chat ---
...
st.markdown("---")
st.caption("Powered by LangChain, Google Gemini, FAISS, and Streamlit. Built by your AI assistant.")